...
//			String q = requeteSite_.requete.getQueryString();
//			if(o.estVide())
//				o.tout("https://", requeteSite_.configSite.nomHoteSite, pageUri, (StringUtils.isEmpty(q) ? "" : "?" + q));
//		}
//	}
//
//	/**
...
//		if(o.estVide())
//			o.tout("https://", requeteSite_.configSite.nomHoteSite, pageImageUri);
//	}
//
//	/**
...
//		Boolean o = requeteSite_.utilisateurRolesContient("SiteAdmin");
//		c.o(o);
//		requeteSite_.pageAdmin(o);
//	}
//
//	/** 
//	 * var.enUS: _pageMethod
//	 * remplacer.enUS: requeteSite_.requete
//	 * siteRequest.request
...
//		if(requeteSite_.requete != null) {
//			String uri = requeteSite_.requete.getRequestURI();
...
//						g("span");
//					g("a");
//					if(requeteSite_.jetonAcces == null) {
...
//		String resultat = "";
//		if(date != null && requeteSite_.requete != null) {
